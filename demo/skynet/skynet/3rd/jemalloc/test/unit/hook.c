...
static void test_alloc_hook(void *extra, hook_alloc_t type, void *result,
...
static void test_dalloc_hook(void *extra, hook_dalloc_t type, void *address,
...
static void test_expand_hook(void *extra, hook_expand_t type, void *address,
                             size_t old_usize, size_t new_usize,
                             uintptr_t result_raw, uintptr_t args_raw[4])
{
    call_count++;
    arg_extra = extra;
    arg_type = (int)type;
...
static void do_realloc_test(void *(*ralloc)(void *, size_t, int), int flags,
