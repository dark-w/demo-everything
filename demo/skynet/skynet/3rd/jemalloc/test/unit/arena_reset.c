...
static void do_arena_reset_pre(unsigned arena_ind, void ***ptrs,
                               unsigned *nptrs)
{
#define NLARGE 32
    ...
    *ptrs = (void **)malloc(*nptrs * sizeof(void *));
    ...
    for (i = 0; i < nsmall; i++) {
        ...
        assert_ptr_not_null((*ptrs)[i], "Unexpected mallocx(%zu, %#x) failure",
                            sz, flags);
    }
    for (i = 0; i < nlarge; i++) {
        sz = get_large_size(i);
...
static bool arena_i_initialized(unsigned arena_ind, bool refresh)
{
    ...
    assert_d_eq(mallctlbymib(mib, miblen, (void *)&initialized, &sz, NULL, 0),
 ...
 */
static bool extent_dalloc_unmap(extent_hooks_t *extent_hooks, void *addr,
