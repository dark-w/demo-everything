...
static void test_prng_lg_range_zu(bool atomic)
{
    ...
    for (lg_range = (ZU(1) << (3 + LG_SIZEOF_PTR)) - 1; lg_range > 0;
        ...
        assert_zu_eq((rb & (SIZE_T_MAX << lg_range)), 0,
                     "High order bits should be 0, lg_range=%u", lg_range);
...
int main(void)
{
    return test(test_prng_lg_range_u32_nonatomic, test_prng_lg_range_u32_atomic,
                ...
                test_prng_lg_range_zu_nonatomic, test_prng_lg_range_zu_atomic,
                test_prng_range_u32_nonatomic, test_prng_range_u32_atomic,
                test_prng_range_u64_nonatomic, test_prng_range_zu_nonatomic,
