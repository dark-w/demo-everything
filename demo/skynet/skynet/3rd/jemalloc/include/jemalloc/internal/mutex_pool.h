...
static inline void mutex_pool_lock(tsdn_t *tsdn, mutex_pool_t *pool,
                                   uintptr_t key)
{
...
static inline void mutex_pool_unlock(tsdn_t *tsdn, mutex_pool_t *pool,
                                     uintptr_t key)
{
    malloc_mutex_t *mutex = mutex_pool_mutex(pool, key);
...
static inline void mutex_pool_lock2(tsdn_t *tsdn, mutex_pool_t *pool,
...
static inline void mutex_pool_unlock2(tsdn_t *tsdn, mutex_pool_t *pool,
                                      uintptr_t key1, uintptr_t key2)
{
    malloc_mutex_t *mutex1 = mutex_pool_mutex(pool, key1);
    malloc_mutex_t *mutex2 = mutex_pool_mutex(pool, key2);
...
static inline void mutex_pool_assert_owner(tsdn_t *tsdn, mutex_pool_t *pool,
                                           uintptr_t key)
{
