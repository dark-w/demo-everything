                                      ...
                                      const void *value)
{
    if (emitter->output == emitter_output_json) {
        emitter_json_key_prefix(emitter);
        emitter_print_value(emitter, emitter_justify_none, -1, value_type,
                            value);
        emitter->item_at_depth = true;
    }
}
...
static inline void emitter_table_kv_note(
    emitter_t *emitter, const char *table_key, emitter_type_t value_type,
    const void *value, const char *table_note_key,
 ...
 */
static inline void emitter_kv_note(emitter_t *emitter, const char *json_key,
                                   const char *table_key,
                                   emitter_type_t value_type, const void *value,
                                   ...
                                   const void *table_note_value)
{
    if (emitter->output == emitter_output_json) {
        ...
        emitter_table_kv_note(emitter, table_key, value_type, value,
                              table_note_key, table_note_value_type,
                              table_note_value);
    }
    emitter->item_at_depth = true;
}

static inline void emitter_kv(emitter_t *emitter, const char *json_key,
                              const char *table_key, emitter_type_t value_type,
                              const void *value)
{
