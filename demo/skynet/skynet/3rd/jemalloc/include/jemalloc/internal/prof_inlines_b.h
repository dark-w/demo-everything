...
JEMALLOC_ALWAYS_INLINE void prof_tctx_set(tsdn_t *tsdn, const void *ptr,
...
JEMALLOC_ALWAYS_INLINE void prof_tctx_reset(tsdn_t *tsdn, const void *ptr,
                                            prof_tctx_t *tctx)
{
    cassert(config_prof);
    assert(ptr != NULL);
...
JEMALLOC_ALWAYS_INLINE void prof_alloc_time_set(tsdn_t *tsdn, const void *ptr,
                                                alloc_ctx_t *alloc_ctx,
                                                nstime_t t)
{
    cassert(config_prof);
...
JEMALLOC_ALWAYS_INLINE bool prof_sample_check(tsd_t *tsd, size_t usize,
                                              bool update)
{
...
JEMALLOC_ALWAYS_INLINE bool prof_sample_accum_update(tsd_t *tsd, size_t usize,
                                                     bool update,
...
JEMALLOC_ALWAYS_INLINE void prof_malloc(tsdn_t *tsdn, const void *ptr,
                                        size_t usize, alloc_ctx_t *alloc_ctx,
                                        prof_tctx_t *tctx)
{
    cassert(config_prof);
...
JEMALLOC_ALWAYS_INLINE void prof_realloc(tsd_t *tsd, const void *ptr,
                                         size_t usize, prof_tctx_t *tctx,
                                         bool prof_active, bool updated,
