...
class WorkerManagerIfSingletonFactory : virtual public WorkerManagerIfFactory {
 public:
  WorkerManagerIfSingletonFactory(const ::std::shared_ptr<WorkerManagerIf>& iface) : iface_(iface) {}
...
class WorkerManagerClient : virtual public WorkerManagerIf {
 public:
  WorkerManagerClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  WorkerManagerClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class WorkerManagerProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  WorkerManagerProcessorFactory(const ::std::shared_ptr< WorkerManagerIfFactory >& handlerFactory) :
...
class WorkerManagerMultiface : virtual public WorkerManagerIf {
 public:
  WorkerManagerMultiface(std::vector<std::shared_ptr<WorkerManagerIf> >& ifaces) : ifaces_(ifaces) {
  }
...
class WorkerManagerConcurrentClient : virtual public WorkerManagerIf {
 public:
  WorkerManagerConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  WorkerManagerConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
