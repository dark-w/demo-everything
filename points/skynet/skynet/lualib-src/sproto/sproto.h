...
struct sproto_type *sproto_protoquery(const struct sproto *, int proto,
                                      int what);
...
int sproto_decode(const struct sproto_type *, const void *data, int size,
                  sproto_callback cb, void *ud);
int sproto_encode(const struct sproto_type *, void *buffer, int size,
                  sproto_callback cb, void *ud);
