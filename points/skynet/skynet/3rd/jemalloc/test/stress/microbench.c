...
static inline void time_func(timedelta_t *timer, uint64_t nwarmup,
                             uint64_t niter, void (*func)(void))
{
    uint64_t i;
                   ...
                   void(*func_a), const char *name_b, void(*func_b))
{
    ...
    malloc_printf("%" FMTu64 " iterations, %s=%" FMTu64 "us, "
                  ...
                  niter, name_a, timer_usec(&timer_a), name_b,
                  timer_usec(&timer_b), ratio_buf);
