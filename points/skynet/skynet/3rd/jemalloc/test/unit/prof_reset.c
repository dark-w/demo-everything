...
static size_t get_lg_prof_sample(void)
{
    ...
    assert_d_eq(
        mallctl("prof.lg_sample", (void *)&lg_prof_sample, &sz, NULL, 0), 0,
...
{
    assert_d_eq(mallctl("prof.reset", NULL, NULL, (void *)&lg_prof_sample,
                        sizeof(size_t)),
...
TEST_BEGIN(test_prof_reset_basic)
{
    ...
    sz = sizeof(size_t);
    assert_d_eq(
        mallctl("opt.lg_prof_sample", (void *)&lg_prof_sample_orig, &sz, NULL,
                0),
        0, "Unexpected mallctl failure while reading profiling sample rate");
