...
static bool ckh_try_bucket_insert(ckh_t *ckh, size_t bucket, const void *key,
                                  const void *data)
{
    ckhc_t *cell;
    unsigned offset, i;
 ...
 */
static bool ckh_evict_reloc_insert(ckh_t *ckh, size_t argbucket,
                                   void const **argkey, void const **argdata)
{
...
static bool ckh_try_insert(ckh_t *ckh, void const **argkey,
                           void const **argdata)
{
