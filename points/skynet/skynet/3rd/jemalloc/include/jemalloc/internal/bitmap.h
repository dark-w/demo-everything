...
static inline bool bitmap_get(bitmap_t *bitmap, const bitmap_info_t *binfo,
                              size_t bit)
{
    size_t goff;
    bitmap_t g;
...
static inline void bitmap_set(bitmap_t *bitmap, const bitmap_info_t *binfo,
                              size_t bit)
{
    size_t goff;
    bitmap_t *gp;
...
static inline size_t bitmap_ffu(const bitmap_t *bitmap,
                                const bitmap_info_t *binfo, size_t min_bit)
{
...
static inline void bitmap_unset(bitmap_t *bitmap, const bitmap_info_t *binfo,
                                size_t bit)
{
    size_t goff;
    bitmap_t *gp;
